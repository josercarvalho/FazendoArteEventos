...
namespace Evento.UI.Controllers
{
    public class DependentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DependenteId,Nome,DataNascimento,Idade,Escola,PlanoSaude,GrupoSanguineo,EmergenciaHospital,Medico,FoneMedico,RestricaoMedicamento,QualMedicamento,RestricaoAlimentar,QualAlimento,PiscinaRestricao,AutorizaPasseio,Observacao,ClienteId")] Dependente dependente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DependenteId,Nome,DataNascimento,Idade,Escola,PlanoSaude,GrupoSanguineo,EmergenciaHospital,Medico,FoneMedico,RestricaoMedicamento,QualMedicamento,RestricaoAlimentar,QualAlimento,PiscinaRestricao,AutorizaPasseio,Observacao,ClienteId")] Dependente dependente)
        {
